package com.example.spoc_v2.ui.fragments.overwiew
    ...
    override fun onCreateView(
       ...
       val args = arguments
        ...
        if(myBundle?.vegan == true){
            ...
            view.vegan_textiew.setTextColor(ContextCompat.getColor(requireContext(), R.color.green))
        }
        ...
        if(myBundle?.veryHealthy == true){
            view.healhy_imageView.setColorFilter(ContextCompat.getColor(requireContext(), R.color.green))
